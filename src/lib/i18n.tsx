...
const translations: Record<Locale, TranslationTable> = {
  'zh-CN': {
    ...
    'history.description': '按 Ctrl+C 复制结果或点击润色按钮后，会把确认过的结果保存到这里。',
    'history.all': '全部',
  ...
  'en-US': {
    ...
    'history.description': 'Results are saved here after you press Ctrl+C to copy them or click the polish button.',
    'history.all': 'All',
