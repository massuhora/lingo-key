...
const translations: Record<Locale, TranslationTable> = {
  'zh-CN': {
    ...
    'main.favoriteReuseHint': '参考收藏：{items}',
    'main.favoriteReuseLabel': '参考收藏',
    'main.loading': '正在整理表达...',
    ...
    'history.title': '历史记录',
    'history.heading': '最近记录与收藏',
    'history.description': '按 Ctrl+C 复制润色结果、复制解释，或点击润色按钮后，会把确认过的结果保存到这里。',
    'history.all': '全部',
    'history.totalCount': '{count} 条',
    'history.polishFilter': '润色 {count}',
    'history.starredFilter': '收藏 {count}',
    'history.searchPlaceholder': '搜索来源、结果或收藏短语',
    'history.clearSearch': '清空搜索',
    'history.loading': '正在读取历史记录...',
    'history.optimizeKind': '润色',
    'history.explainKind': '解释',
    'history.favorite': '加入收藏',
    'history.unfavorite': '取消收藏',
    'history.delete': '删除记录',
    'history.useItem': '使用',
    'history.savedBadge': '已收藏',
    'history.favoriteReuseNote': '会在匹配的新润色中作为偏好参考',
    'history.source': '来源',
    'history.result': '结果',
    'history.meaning': '释义',
    'history.emptyTitle': '还没有历史记录',
    'history.emptyDescription': '按 Ctrl+C 复制结果，或点击润色按钮后，它会出现在这里。',
    'history.emptyFavoritesTitle': '还没有收藏',
    'history.emptyFavoritesDescription': '点亮星标后，重要表达会集中在这里。',
    'history.emptySearchTitle': '没有匹配结果',
    'history.emptySearchDescription': '换个关键词，或清空搜索继续浏览历史。',
    'explain.title': '解释',
    'explain.status': 'Instant Explain',
    'explain.triggerHint': '选中文本后触发',
    'explain.original': '原文',
    'explain.meaning': '{language}释义',
    'explain.partOfSpeech': '词性',
    'explain.usage': '习惯用法',
    ...
    'settings.hotkeyError.invalid': '{field}快捷键无效。请至少包含一个修饰键和一个普通按键，例如 Ctrl+Shift+L。',
    'settings.hotkeyError.duplicate': '{current}和{other}使用了同一个快捷键。请为每个模式设置不同组合。',
    'settings.hotkeyValidationFailed': '快捷键需要修正',
    'settings.hotkeyValidationDescription': '修正无效或重复的快捷键后才能保存设置。',
  ...
  'en-US': {
    ...
    'main.favoriteReuseHint': 'Referencing favorites: {items}',
    'main.favoriteReuseLabel': 'Using favorites',
    ...
    'history.heading': 'Recent items and favorites',
    'history.description': 'Results are saved here after you press Ctrl+C, copy an explanation, or click the polish button.',
    'history.all': 'All',
    'history.totalCount': '{count} items',
    'history.polishFilter': 'Polish {count}',
    'history.starredFilter': 'Starred {count}',
    'history.searchPlaceholder': 'Search source, result, or saved phrasing',
    'history.clearSearch': 'Clear search',
    'history.loading': 'Loading history...',
    'history.optimizeKind': 'Polish',
    'history.explainKind': 'Explain',
    'history.favorite': 'Add to favorites',
    'history.unfavorite': 'Remove from favorites',
    'history.delete': 'Delete item',
    'history.useItem': 'Use',
    'history.savedBadge': 'Saved',
    'history.favoriteReuseNote': 'Used as a preference when a new polish request matches',
    'history.source': 'Source',
    'history.result': 'Result',
    'history.meaning': 'Meaning',
    'history.emptyTitle': 'No history yet',
    'history.emptyDescription': 'Press Ctrl+C to copy a result or click the polish button, and it will appear here.',
    'history.emptyFavoritesTitle': 'No favorites yet',
    'history.emptyFavoritesDescription': 'Star important items to keep them here.',
    'history.emptySearchTitle': 'No matches',
    'history.emptySearchDescription': 'Try another keyword or clear search to browse everything.',
    ...
    'explain.partOfSpeech': 'Part of Speech',
    'explain.usage': 'Usage',
    ...
    'settings.hotkeyError.invalid': '{field} has an invalid shortcut. Use at least one modifier and one key, for example Ctrl+Shift+L.',
    'settings.hotkeyError.duplicate': '{current} and {other} use the same shortcut. Set a different combination for each mode.',
    'settings.hotkeyValidationFailed': 'Hotkeys need attention',
    'settings.hotkeyValidationDescription': 'Fix invalid or duplicate hotkeys before saving settings.',
