...
const translations: Record<Locale, TranslationTable> = {
  'zh-CN': {
    ...
    'main.inputTitle': '输入',
    'main.inputDescription': '输入你想表达的内容，LingoKey 会整理成 {language}。',
    ...
    'settings.summaryLanguages': '语言配置',
    'settings.summaryProfile': '输出模式',
    'settings.summarySync': '同步状态',
    'settings.languageSectionTitle': '语言',
    'settings.languageSectionDescription': '设置界面语言、母语和学习语言。',
    'settings.uiLanguage': '界面语言',
    'settings.uiLanguageDescription': '切换应用界面的显示语言。',
    'settings.nativeLanguage': '母语',
    'settings.nativeLanguageDescription': '解释窗口会优先用{language}给出释义和语境说明。',
    'settings.learningLanguage': '学习语言',
    'settings.learningLanguageDescription': '主窗口始终输出{language}，解释窗口默认也把划词内容视为{language}。',
    'settings.languageSectionHint': '主窗口会把输入整理成学习语言；解释窗口默认将划词视为学习语言，并用母语给出释义。',
    'settings.languageSummaryValue': '母语 {native} / 学习 {learning}',
    ...
    'settings.hotkeysDescription': '为三个模式设置更顺手的全局热键组合。',
    'settings.hotkeysBadge': '3 组热键',
    'settings.hotkey.main': '润色模式',
    'settings.hotkey.explain': '解释模式',
    'settings.hotkey.settings': '设置模式',
    ...
    'settings.footerUnsavedDescription': '保存后会立即应用到同一个窗口。',
  ...
  'en-US': {
    ...
    'common.backToPrompt': 'Back to Polish',
    ...
    'main.inputDescription': 'Enter what you want to express and LingoKey will rewrite it into {language}.',
    ...
    'main.pinWindow': 'Pin Window',
    'main.unpinWindow': 'Unpin Window',
    ...
    'settings.summaryLanguages': 'Language Setup',
    'settings.summaryProfile': 'Output Style',
    'settings.summarySync': 'Sync',
    'settings.languageSectionTitle': 'Language',
    'settings.languageSectionDescription': 'Set the UI language, native language, and learning language.',
    ...
    'settings.nativeLanguageDescription': 'The explain window gives meanings and context in {language}.',
    'settings.learningLanguage': 'Learning Language',
    'settings.learningLanguageDescription': 'The main window always writes in {language}, and the explain window treats selected text as {language}.',
    'settings.languageSectionHint': 'The main window always outputs the learning language. The explain window assumes selected text is in the learning language and explains it in the native language.',
    'settings.languageSummaryValue': 'Native {native} / Learning {learning}',
    ...
    'settings.hotkeysDescription': 'Set a convenient global shortcut for each mode.',
    'settings.hotkeysBadge': '3 Hotkeys',
    'settings.hotkey.main': 'Polish Mode',
    'settings.hotkey.explain': 'Explain Mode',
    'settings.hotkey.settings': 'Settings Mode',
    ...
    'settings.footerUnsavedDescription': 'Saving applies the changes to the unified window immediately.',
