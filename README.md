...
The current version is `0.3.8`. The repository is still in the MVP stage. The core capabilities are already usable, but the main focus is still on polishing the experience, tightening the workflow, and validating product boundaries.
